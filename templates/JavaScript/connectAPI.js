...
function getModelResult_NF(sea, wbc, crp, seg, band) {
  return new Promise((resolve, reject) => {
    var dataUrl = "https://nfsepsisanalysis-xiglc7mhia-uc.a.run.app/GET/predict/NF";
    var xhr = new XMLHttpRequest();
...
function getModelResult_sepsis(gcs, meds_ams15b, meds_plt150b, sofa_res, sofa_ner, sofa_liver,
  ...
  return new Promise((resolve, reject) => {
    var dataUrl = "https://nfsepsisanalysis-xiglc7mhia-uc.a.run.app/GET/predict/sepsis";
    var xhr = new XMLHttpRequest();
    xhr.open('POST', dataUrl, true);
    xhr.setRequestHeader('Content-Type', 'application/json');
    // xhr.setRequestHeader('Authorization', 'Bearer ' + token)
...
function getToken_fhir() {
  return new Promise((resolve, reject) => {
    var dataUrl = "https://nfsepsisanalysis-xiglc7mhia-uc.a.run.app/GET/token_fhir";
    var xhr = new XMLHttpRequest();
    xhr.open('GET', dataUrl, true);
    xhr.send();
