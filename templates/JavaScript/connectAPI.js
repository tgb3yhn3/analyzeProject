...
function getObservationById(token, id) {
  return new Promise((resolve, reject) => {
    var dataUrl = "https://healthcare.googleapis.com/v1beta1/projects/crack-will-380312/locations/asia-east1/datasets/test2/fhirStores/test2/fhir/Observation?subject=Patient/" + id;
    var xhr = new XMLHttpRequest();
    xhr.open('GET', dataUrl, true);
    xhr.setRequestHeader('Authorization', 'Bearer ' + token)
    xhr.send();
