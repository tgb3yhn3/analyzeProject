...
function getPatient(token) {
  return new Promise((resolve, reject) => {
    var dataUrl = "https://healthcare.googleapis.com/v1/projects/agile-device-389611/locations/asia-east1/datasets/fhir/fhirStores/fhir/fhir/Patient";
...
function getPatientById(token, id) {
  return new Promise((resolve, reject) => {
    var dataUrl = "https://healthcare.googleapis.com/v1/projects/agile-device-389611/locations/asia-east1/datasets/fhir/fhirStores/fhir/fhir/Patient/" + id;
    var xhr = new XMLHttpRequest(); // XMLHttpRequest物件(以此物件的方法進行資料請求)
    xhr.open('GET', dataUrl, true); // 以GET方法開啟一個請求 //open('Method',API的URL,預設值為true非同步進行)
    xhr.setRequestHeader('Authorization', 'Bearer ' + token)
    xhr.send(); // 送出請求(若為GET參數不填或填null)
...
function getHeightById(token, id) {
  return new Promise((resolve, reject) => {
    var dataUrl = "https://healthcare.googleapis.com/v1/projects/agile-device-389611/locations/asia-east1/datasets/fhir/fhirStores/fhir/fhir/Observation?subject=" + id + "&code=http://loinc.org|8302-2" + "&_sort=-date";
...
function getWeightById(token, id) {
  return new Promise((resolve, reject) => {
    var dataUrl = "https://healthcare.googleapis.com/v1/projects/agile-device-389611/locations/asia-east1/datasets/fhir/fhirStores/fhir/fhir/Observation?subject=" + id + "&code=http://loinc.org|29463-7" + "&_sort=-date";
    var xhr = new XMLHttpRequest();
    xhr.open('GET', dataUrl, true);
    xhr.setRequestHeader('Authorization', 'Bearer ' + token)
    xhr.send();
...
function getObservationById(token, id) {
  return new Promise((resolve, reject) => {
    var dataUrl = "https://healthcare.googleapis.com/v1/projects/agile-device-389611/locations/asia-east1/datasets/fhir/fhirStores/fhir/fhir/Observation?subject=Patient/" + id+"&_count=500";
    var xhr = new XMLHttpRequest();
    xhr.open('GET', dataUrl, true);
    xhr.setRequestHeader('Authorization', 'Bearer ' + token)
    xhr.send();
...
function getObservationByCode(token, id, code) {
  return new Promise((resolve, reject) => {
    var dataUrl = "https://healthcare.googleapis.com/v1/projects/agile-device-389611/locations/asia-east1/datasets/fhir/fhirStores/fhir/fhir/Observation?subject=" + id + "&code=http://loinc.org|" + code + "&_sort=-date";
    var xhr = new XMLHttpRequest();
    xhr.open('GET', dataUrl, true);
    xhr.setRequestHeader('Authorization', 'Bearer ' + token)
    xhr.send();
...
function getToken_fhir() {
  ...
  //開始PUT
  let url = "https://healthcare.googleapis.com/v1/projects/agile-device-389611/locations/asia-east1/datasets/fhir/fhirStores/fhir/fhir/Patient/" + id;
...
function update_data(token,id,source_type,data_type,data){//no use
  ...
  const url = "https://healthcare.googleapis.com/v1/projects/agile-device-389611/locations/asia-east1/datasets/fhir/fhirStores/fhir/fhir/"+source_type+"/"+data_type;
