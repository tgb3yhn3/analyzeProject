...
function back_click(element) {
    window.location.replace('https://fhir-dm5wodoipq-de.a.run.app/NFchoice?id=' + id);
}

function backlist(element) {
    window.location.replace('https://fhir-dm5wodoipq-de.a.run.app/patientlist');
}
...
function detail(element) {
    window.open('https://fhir-dm5wodoipq-de.a.run.app/NFbodyvalue' + '?sea=' + sea + '&wbc=' + wbc + '&crp=' + crp + '&seg=' + seg + '&band=' + band)
}
